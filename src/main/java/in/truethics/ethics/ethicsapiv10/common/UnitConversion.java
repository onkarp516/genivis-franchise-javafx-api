        ...
        try {
            ...
            if (inventorySummaryTransactionDetails != null) {
                ...
                for (ProductUnitPacking productUnitPacking : productList) {
                    ...
                    jsonObject.addProperty("unitConv", productUnitPacking.getUnitConversion() != null ? productUnitPacking.getUnitConversion() : 0);
                    ...
                    jsonObject.addProperty("fsrmh", productUnitPacking.getFsrmh() != null ? productUnitPacking.getFsrmh() : 0.0);
                    jsonObject.addProperty("fsrai", productUnitPacking.getFsrai() != null ? productUnitPacking.getFsrai() : 0.0);
                    jsonObject.addProperty("csrmh", productUnitPacking.getCsrmh() != null ? productUnitPacking.getCsrmh() : 0.0);
                    jsonObject.addProperty("csrai", productUnitPacking.getCsrai() != null ? productUnitPacking.getCsrai() : 0.0);
                    ...
                    jsonObject.addProperty("is_negetive", productUnitPacking.getIsNegativeStocks() != null ? productUnitPacking.getIsNegativeStocks() : false);
...
//                    jsonObject.addProperty("isExpired", productBatchNo.getPurchaseRate() == null ? "" : productBatchNo.getPurchaseRate().toString());
                ...
                for (ProductUnitPacking unitPacking :
                    ...
                    if (currentStock != null) {
                        ...
                        stockObject.addProperty("fsrmh", unitPacking.getFsrmh() != null ? unitPacking.getFsrmh() : 0.0);
                        stockObject.addProperty("fsrai", unitPacking.getFsrai() != null ? unitPacking.getFsrai() : 0.0);
                        stockObject.addProperty("csrmh", unitPacking.getCsrmh() != null ? unitPacking.getCsrmh() : 0.0);
                        stockObject.addProperty("csrai", unitPacking.getCsrai() != null ? unitPacking.getCsrai() : 0.0);
...
/*                    jsonObject.addProperty("unitid", productUnitPacking.getUnits().getId());
                    ...
                    *//*** multi unit rate convesrion ***//*
                    ...
                    frUnitWiseRatesDTO.setFsrmh(productUnitPacking.getFsrmh() != null ? productUnitPacking.getFsrmh() : 0.0);
                    frUnitWiseRatesDTO.setFsrai(productUnitPacking.getFsrai() != null ? productUnitPacking.getFsrai() : 0.0);
                    frUnitWiseRatesDTO.setCsrmh(productUnitPacking.getCsrmh() != null ? productUnitPacking.getCsrmh() : 0.0);
                    frUnitWiseRatesDTO.setCsrai(productUnitPacking.getCsrai() != null ? productUnitPacking.getCsrai() : 0.0);
