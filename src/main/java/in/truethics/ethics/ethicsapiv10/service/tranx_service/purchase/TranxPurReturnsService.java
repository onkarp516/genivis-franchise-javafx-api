...
import in.truethics.ethics.ethicsapiv10.dto.purchasedto.PurReturnDTO;
...
//        invoiceTranx.setTcs(Double.parseDouble(request.getParameter("tcs")));
    ...
    public void saveIntoPurchaseAdditionalCharges(JsonArray additionalCharges, TranxPurReturnInvoice mPurchaseTranx, Long tranxId, Long outletId) {
        List<TranxPurReturnInvoiceAddCharges> chargesList = new ArrayList<>();
        if (mPurchaseTranx.getAdditionalChargesTotal() > 0) {
            for (JsonElement mList : additionalCharges) {
                TranxPurReturnInvoiceAddCharges charges = new TranxPurReturnInvoiceAddCharges();
    ...
    public void saveIntoPurchaseInvoiceDetails(JsonArray array, TranxPurReturnInvoice mPurchaseTranx, Branch branch, Outlet outlet, Long userId, TransactionTypeMaster tranxType, HttpServletRequest request) {
