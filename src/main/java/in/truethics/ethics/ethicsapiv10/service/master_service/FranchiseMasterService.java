...
public class FranchiseMasterService {
        ...
        if (validateDuplicateCompany(request.getParameter("franchiseName"))) {
            ...
            try {
                ...
                if (paramMap.containsKey("countryId")) {
                    Country country = countryRepository.findById(Long.parseLong(request.getParameter("countryId")))
                            .get();
                    if (country != null)
                ...
                if (franchise.getIsFunded() && paramMap.containsKey("fundAmt")
                        && !request.getParameter("fundAmt").isEmpty())
                ...
                if (savedFranchise != null) {
                    try {
                        ...
                        String response = restTemplate.exchange(
                                serverFrUrl + "/saveFranchiseSuperadmin", HttpMethod.POST, entity, String.class)
                                .getBody();
    ...
    private Boolean validateDuplicateCompany(String franchiseName) {
        FranchiseMaster franchiseMaster = franchiseRepository.findByFranchiseNameIgnoreCaseAndStatus(franchiseName,
                true);
        Boolean flag;
    ...
    public JsonObject getFranchiseById(HttpServletRequest request) {
        ...
        if (franchiseMaster != null) {
            ...
            response.addProperty("partnerName",
                    franchiseMaster.getPartnerName() != null ? franchiseMaster.getPartnerName() : "");
            ...
            response.addProperty("presentoccupation",
                    franchiseMaster.getPresentOccupation() != null ? franchiseMaster.getPresentOccupation() : "");
            response.addProperty("latitude",
                    franchiseMaster.getLatitude() != null ? franchiseMaster.getLatitude() : "");
            response.addProperty("longitude",
                    franchiseMaster.getLongitude() != null ? franchiseMaster.getLongitude() : "");
            response.addProperty("gender", franchiseMaster.getGender() != null ? franchiseMaster.getGender() : "");
            response.addProperty("bankName",
                    franchiseMaster.getBankName() != null ? franchiseMaster.getBankName() : "");
            response.addProperty("accountNum",
                    franchiseMaster.getAccountNumber() != null ? franchiseMaster.getAccountNumber() : "");
            response.addProperty("ifsc", franchiseMaster.getIfsc() != null ? franchiseMaster.getIfsc() : "");
            response.addProperty("address",
                    franchiseMaster.getFranchiseAddress() != null ? franchiseMaster.getFranchiseAddress() : "");
            ...
            response.addProperty("residencialstate",
                    franchiseMaster.getResidencialState() != null
                            ? franchiseMaster.getResidencialState().toString().toUpperCase()
                            : "");
            response.addProperty("state",
                    franchiseMaster.getState() != null ? franchiseMaster.getState().getName() : "");
            response.addProperty("franchisestateId",
                    franchiseMaster.getState() != null ? franchiseMaster.getState().getId().toString() : "");
            ...
            if (franchiseMaster.getResidencialArea().equalsIgnoreCase("")) {
                ...
                try {
                    PincodeMaster pincodeMaster = pincodeMasterRepository.findByAreaAndDistrictAndPincode(
                            franchiseMaster.getResidencialArea(), franchiseMaster.getResidencialDistrict(),
                            franchiseMaster.getCorpPincode());
        ...
        try {
            if (franchiseMaster != null) {
                ...
                if (paramMap.containsKey("stateCode")) {
                    ...
                    franchiseMaster.setStateCode("");
                if (paramMap.containsKey("residencialState")) {
                    // List<State> state =
                    // stateRepository.findByStateCode(request.getParameter("residencialState"));
                    // if (state != null) {
    ...
    public JsonObject getAllFranchise(HttpServletRequest request) {
        ...
        if (list.size() > 0) {
            for (FranchiseMaster franchiseMaster : list) {
                ...
                response.addProperty("isFunded",
                        franchiseMaster.getIsFunded() != null ? franchiseMaster.getIsFunded() : false);
                response.addProperty("fundAmt",
                        franchiseMaster.getFundAmt() != null ? franchiseMaster.getFundAmt() : 0.00);
                result.add(response);
            }
            res.addProperty("message", "success");
            res.addProperty("responseStatus", HttpStatus.OK.value());
    ...
    /*
     * public String saveFranchiseSuperadmin(Map<String, String> jsonRequest,
     ...
     * users.setEmail(jsonRequest.get("email"));
     * else users.setEmail("");
     ...
     * if (jsonRequest.containsKey("address"))
     * users.setAddress(jsonRequest.get("address"));
     * else users.setAddress("");
     * users.setStatus(true);
     * users.setPassword(bcryptEncoder.passwordEncoderNew().encode(jsonRequest.get(
     * "password")));
     ...
     * "Franchise Super admin created successfully");
     * response.addProperty("ResponseStatus", HttpStatus.OK.value());
     * } catch (Exception e) {
     * franchiseLogger.error("Exception in saveFranchiseSuperadmin:" +
     * e.getMessage());
     * response.addProperty("Message", "Internal Server Error");
     * response.addProperty("ResponseStatus",
