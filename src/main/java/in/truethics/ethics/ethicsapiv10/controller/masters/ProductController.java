...
public class ProductController {
    ...
    @PostMapping(path = "/create_product_from_gv")
    public Object createProductFromGV(MultipartHttpServletRequest request) {
        return productService.createProductFromGv(request);
    }

    @PostMapping(path = "/update_product_from_gv")
    public Object updateProductFromGV(MultipartHttpServletRequest request) {
        return productService.updateProductFromGv(request);
    }
    ...
    @PostMapping(path = "/get_product_list_by_barcode")
    public Object getTransactionListByBarcode(HttpServletRequest request) {
        return productService.getProductListByBarcode(request).toString();
    }
...
//        return productService.GVProductList(request, req);
        return ResponseEntity.ok(productService.GVProductList(request,req));
    }
*/

    @PostMapping(path = "/mobile/v1/fr-prd-list")
    public Object FRProductList(@RequestBody Map<String, String> request, HttpServletRequest req) {
            return productService.FRProductList(request, req);
    }

    @PostMapping(path = "/mobile/v1/fr-live-prd-list")
    public Object FRLiveProductList(@RequestBody Map<String, String> request, HttpServletRequest req) {
        return productService.GVProductList(request, req);
    }
}
