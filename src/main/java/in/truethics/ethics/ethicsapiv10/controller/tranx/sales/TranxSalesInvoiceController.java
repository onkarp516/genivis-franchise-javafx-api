...
/*** Used For CounterSale In JavaFX ****/
...
//    }
    ...
    /* getting last records of Counter Sales Invoices */
    @GetMapping(path = "frcs/mobile/get_counter_sales_last_invoice_record")
    public Object frCounterSaleRecord(HttpServletRequest request) {
        JsonObject result = service.frCounterSaleRecord(request);
        return result.toString();
    }

    @GetMapping(path = "/dashboard/list_sale_invoice")
    public Object dashboardSaleList(HttpServletRequest request) {
        JsonObject result = service.dashboardSaleList(request);
        return result.toString();
    }

    @GetMapping(path = "/dashboard/top_selling")
    public Object dashboardTopSelling(HttpServletRequest request) {
        JsonObject result = service.dashboardTopSelling(request);
        return result.toString();
    }

    @GetMapping(path = "/dashboard/least_selling")
    public Object dashboardLeastSelling(HttpServletRequest request) {
        JsonObject result = service.dashboardLeastSelling(request);
        return result.toString();
    }
