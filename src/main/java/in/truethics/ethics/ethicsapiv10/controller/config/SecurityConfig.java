...
public class SecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/authenticate", "/api/token/refresh/**",
                ...
                "/po_to_so_invoices","/sc_to_pc_invoices", "/si_to_pi_invoices","/mLogin", "/mobile/git zonalHeadDetail",
                "/create_receipt_fr","/get_gv_batch_data", "/getGvBankLedgers","/mobile/v1/gv-live-prd-list","/get_po_invoices_with_ids","/create_product_from_gv","/update_product_from_gv","/mobile/v1/fr-authenticate" +
                        "").permitAll();
