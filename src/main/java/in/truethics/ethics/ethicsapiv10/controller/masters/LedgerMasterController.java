...
public class LedgerMasterController {
  ...
  /*  @GetMapping(path = "/get_debtors_total_amount")
   ...
   /* @GetMapping(path = "/get_fr_ledger_list")
    ...
    /**** Get All bank details of GV Ledger,  *****/
    @GetMapping(path = "/get_gv_bank_details")
    public Object getGvBankDetails(HttpServletRequest request) {
        JsonObject result = service.getGvBankDetails(request);
        return result.toString();
    }
}
