...
//    }
    ...
    @PostMapping(path = "/get_Dashboard_Cash_summary")
    public Object getDashboardCashSummary(HttpServletRequest request) {
        return stockService.getDashboardCashSummary(request).toString();
    }
