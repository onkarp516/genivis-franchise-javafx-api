...
//        return  service.purchasemobileList(request);
    ...
    /*dashboard purchase API*/
    @GetMapping(path = "/dashboard/list_purchase_invoice")
    public Object dashboardPucrhaseList(HttpServletRequest request) {
        JsonObject result = service.dashboardPucrhaseList(request);
        return result.toString();
    }
}
